...
extension WebRequest {
    func urlRequest(givenConfig config: WebRepositoryConfig) throws  -> URLRequest {
    ...
    private func urlComponents(givenConfig config: WebRepositoryConfig) -> URLComponents {
